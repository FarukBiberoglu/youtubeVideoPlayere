...
class DatabaseMethods {
  ...
  Future addVideo(Map<String, dynamic> userVideo, String id) async {
    return await FirebaseFirestore.instance
        .collection('Course')
        .doc(id).collection('Videos')
        .add(userVideo);
  }
  Future<Stream<QuerySnapshot>> getAllVideos (String id) async {
    return await FirebaseFirestore.instance.collection('Course').doc(id).collection('Videos').snapshots() ;
  }
